              ...
              <form class="needs-validation" novalidate>
                <div class="row g-3">
                 ...
                 <div class="col-12">
                    ...
                    <input type="number" name= "cust_phone"class="form-control" id="cust_phone" placeholder="+91">
                    <div class="invalid-feedback">
                 ...
                 <div class="col-12">
                    ...
                    <input type="email"name= "cust_email" class="form-control" id="cust_email" placeholder="email@example.com">
                    <div class="invalid-feedback">
                  ...
                  <div class="col-12">
                    ...
                    <input type="password" name= "cust_pwd" class="form-control" id="cust_pwd" placeholder="Strong password needed">
                    <div class="invalid-feedback">
