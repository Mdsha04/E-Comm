    ...
    public List<coupon> getCoupons(){
        return template.query("select * from coupon",new RowMapper<coupon>(){    
            ...
            public coupon mapRow(ResultSet rs, int row) throws SQLException {    
                ...
                e.setCat(dao.getcategoryById(rs.getInt(4)));
...
//                e.setCat(dao.getcategoryById(rs.getInt(5))); 
    ...
    public int addcoupon(coupon e){
       String sql="insert into coupon(COUPON_ID,COUPON_NAME,E_ID,CAT_ID,discount) values("+e.getCoupon_id()+",'"+e.getCoupon_name()+"',"+e.getE().getE_id()+","+e.getCat().getCat_id()+","+e.getDiscount()+")";
