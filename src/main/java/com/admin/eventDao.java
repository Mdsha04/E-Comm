...
public int addEvent(event e){
       String sql="insert into Event(e_id, e_name, e_start, e_end) values("+e.getE_id()+",'"+e.getE_name()+"',TO_DATE('"+e.getStartDate()+"','YYYY/MM/DD'),TO_DATE('"+e.getEnd_date()+"' ,'YYYY/MM/DD') )";
