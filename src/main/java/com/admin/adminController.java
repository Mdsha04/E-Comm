...
//    ----------------------Admin--------------------------------------
    ...
    public String addproduct(@RequestParam("P_ID") int p_id,@RequestParam("P_name") String p_name,@RequestParam("Price") int price,@RequestParam("cat_id") int cat_id,@RequestParam("imagePath") CommonsMultipartFile file,HttpSession s){
